  ...
  */
  ...
  var DrawBounds = function DrawBounds(graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      color = GetValue$h(config, 'color', 0xffffff);
  ...
  var ComponentBase = /*#__PURE__*/function () {
    function ComponentBase(parent, config) {
      ...
      this.setEventEmitter(GetValue$e(config, 'eventEmitter', true)); // Register callback of parent destroy event, also see `shutdown` method
  ...
  var TickTask = /*#__PURE__*/function (_ComponentBase) {
    ...
    function TickTask(parent, config) {
      ...
      _this.setTickingMode(GetValue$d(config, 'tickingMode', 1)); // boot() later
  ...
  var Button = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Button, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setMode(GetValue$7(o, "mode", 1));
        this.setClickInterval(GetValue$7(o, "clickInterval", 100));
        this.setDragThreshold(GetValue$7(o, 'threshold', undefined));
        return this;
      }
    }, {
      key: "boot",
  ...
  var Base = /*#__PURE__*/function (_Container) {
    ...
    function Base(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.setDraggable(GetValue$6(config, 'draggable', false));
  ...
  var Add = function Add(gameObject, proportion, align, paddingConfig, expand, childKey, index, minSize) {
    ...
    if (proportion === null) {
      ...
      proportion = GetValue$5(config, 'proportion', 0);
      ...
      if (!gameObject.isRexSizer) {
        ...
        if (this.orientation === 0) {
          // x
          minSize = GetValue$5(config, 'minWidth', undefined);
        } else {
          // y
          minSize = GetValue$5(config, 'minHeight', undefined);
        }
      }
    }
  ...
  var Label = /*#__PURE__*/function (_Sizer) {
    ...
    function Label(scene, config) {
      ...
      var actionMask = GetValue$3(config, 'actionMask', undefined); // Align

      var align = GetValue$3(config, 'align', undefined); // undefined/left/top: no space
      // Space

      var iconSpace = GetValue$3(config, 'space.icon', 0);
  ...
  var TextPage = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(TextPage, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.setMaxLines(GetValue$2(o, 'maxLines', undefined));
        this.setPageBreak(GetValue$2(o, 'pageBreak', '\f\n'));
        this.setText(GetValue$2(o, 'text', ''));
        this.setStartLineIndex(GetValue$2(o, 'start', 0));
        this.setPageIndex(GetValue$2(o, 'page', -1));
        return this;
      }
    }, {
      key: "toJSON",
