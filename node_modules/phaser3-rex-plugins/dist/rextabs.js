  ...
  */
  ...
  var DrawBounds = function DrawBounds(graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      color = GetValue$j(config, 'color', 0xffffff);
  ...
  var Button = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Button, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setMode(GetValue$9(o, "mode", 1));
        this.setClickInterval(GetValue$9(o, "clickInterval", 100));
        this.setDragThreshold(GetValue$9(o, 'threshold', undefined));
        return this;
      }
    }, {
      key: "boot",
  ...
  Object.assign(methods$3, PaddingMethods, AddChildMethods$3, GetParentSizerMethods, ScaleMethods, FadeMethods, EaseMoveMethods, ClickMethods, HideMethods, GetShownChildrenMethods);
  ...
  var Base = /*#__PURE__*/function (_Container) {
    ...
    function Base(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.setDraggable(GetValue$8(config, 'draggable', false));
  ...
  var ResetGrid = function ResetGrid(columnCount, rowCount, columnProportions, rowProportions, space) {
    ...
    var columnSpace = GetValue$6(space, 'column', 0);
    ...
    var rowSpace = GetValue$6(space, 'row', 0);
  ...
  var GridSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function GridSizer(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
      ...
      if (IsPlainObject$2(x)) {
        ...
        columnCount = GetValue$5(config, 'column', 0);
      ...
      var createCellContainerCallback = GetValue$5(config, 'createCellContainerCallback');
