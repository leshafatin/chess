(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexfixwidthbuttons = factory());
  ...
  */
  ...
  var DrawBounds = function DrawBounds(graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      color = GetValue$f(config, 'color', 0xffffff);
  ...
  var Button = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Button, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setMode(GetValue$5(o, "mode", 1));
        this.setClickInterval(GetValue$5(o, "clickInterval", 100));
        this.setDragThreshold(GetValue$5(o, 'threshold', undefined));
        return this;
      }
    }, {
      key: "boot",
  ...
  var FixWidthSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function FixWidthSizer(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.setOrientation(GetValue$2(config, 'orientation', 0));

      _this.setItemSpacing(GetValue$2(config, 'space.item', 0));

      _this.setLineSpacing(GetValue$2(config, 'space.line', 0));

      _this.setAlign(GetValue$2(config, 'align', 0));

      _this.setJustifyPercentage(GetValue$2(config, 'justifyPercentage', 0.25));
  ...
  var Buttons = /*#__PURE__*/function (_FixWidthSizer) {
    ...
    function Buttons(scene, config) {
      ...
      _this.buttonsAlign = GetValue(config, 'align', undefined);
