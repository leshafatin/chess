  ...
  */
  ...
  var DrawBounds = function DrawBounds(graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      color = GetValue$i(config, 'color', 0xffffff);
  ...
  var Button = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Button, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setMode(GetValue$8(o, "mode", 1));
        this.setClickInterval(GetValue$8(o, "clickInterval", 100));
        this.setDragThreshold(GetValue$8(o, 'threshold', undefined));
        return this;
      }
    }, {
      key: "boot",
  ...
  var Base = /*#__PURE__*/function (_Container) {
    ...
    function Base(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.setDraggable(GetValue$7(config, 'draggable', false));
  ...
  var Add = function Add(gameObject, proportion, align, paddingConfig, expand, childKey, index, minSize) {
    ...
    if (proportion === null) {
      ...
      proportion = GetValue$6(config, 'proportion', 0);
      align = GetValue$6(config, 'align', ALIGN_CENTER);
      ...
      if (!gameObject.isRexSizer) {
        ...
        if (this.orientation === 0) {
          // x
          minSize = GetValue$6(config, 'minWidth', undefined);
        } else {
          // y
          minSize = GetValue$6(config, 'minHeight', undefined);
        }
      }
    }
  ...
  var Player = /*#__PURE__*/function (_ComponentBase) {
    ...
    function Player(parent, config) {
      ...
      _this = _super.call(this, parent, config);
      var clockClass = GetValue$1(config, 'clockClass', Clock);
