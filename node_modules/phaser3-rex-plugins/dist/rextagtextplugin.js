(function (global, factory) {
  ...
  var TagTextPlugin = /*#__PURE__*/function (_Phaser$Plugins$BaseP) {
    _inherits(TagTextPlugin, _Phaser$Plugins$BaseP);

    var _super = _createSuper(TagTextPlugin);

    function TagTextPlugin(pluginManager) {
      var _this;

      _classCallCheck(this, TagTextPlugin);
