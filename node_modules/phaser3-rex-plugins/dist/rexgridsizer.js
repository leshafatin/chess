(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexgridsizer = factory());
  ...
  */
  ...
  var ResolveWidth = function ResolveWidth(width) {
    var width = ResolveWidth$1.call(this, width); // Get proportionLength
  ...
  var Add = function Add(gameObject, columnIndex, rowIndex, align, paddingConfig, expand, childKey) {
    ...
    if (IsPlainObject$1(columnIndex)) {
      ...
      columnIndex = GetValue$2(config, 'column', undefined);
      rowIndex = GetValue$2(config, 'row', undefined);
  ...
  var ResetGrid = function ResetGrid(columnCount, rowCount, columnProportions, rowProportions, space) {
    ...
    var columnSpace = GetValue$1(space, 'column', 0);
    ...
    var rowSpace = GetValue$1(space, 'row', 0);
